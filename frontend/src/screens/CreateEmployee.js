// frontend/src/screens/CreateEmployee.js
...
const CreateEmployee = () => {
    ...
    const validateForm = async () => {
        ...
        if (!form.f_Email) {
            ...
            try {
                const response = await axios.get(`http://localhost:5000/api/employees?email=${form.f_Email}`);
                if (response.data.length > 0) {
                    newErrors.f_Email = 'Email already exists';
                }
            } catch (error) {
        ...
        <div className="container mt-5">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    ...
                    />
                    {errors.f_Id && <div className="text-danger">{errors.f_Id}</div>}
                </div>
